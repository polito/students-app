...
import { useGetCourseVideolectures } from '@core/queries/courses';
...
type Props = NativeStackScreenProps<CoursesStackParamList, 'Videolecture'>;

export const Videolecture = ({ route }: Props) => {
