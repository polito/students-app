...
import { useGetCourseVirtualClassrooms } from '@core/queries/courses';
...
type Props = NativeStackScreenProps<CoursesStackParamList, 'VirtualClassroom'>;

export const VirtualClassroom = ({ route }: Props) => {
