...
import { isDirectory } from '../../teaching/utils/fs-entry';
...
type Props = NativeStackScreenProps<CoursesStackParamList, 'Directory'>;
...
export const Directory = ({ route, navigation }: Props) => {
