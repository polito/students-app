...
import { useGetCourse } from '@core/queries/courses';
...
type Props = NativeStackScreenProps<CoursesStackParamList, 'Preferences'>;

export const Preferences = ({ navigation, route }: Props) => {
  const { t } = useTranslation();
          ...
          <Section>
            ...
            <SectionList loading={courseQuery.isLoading} indented>
              ...
              <ListItem
                title={t('common.icon')}
                isAction
                onPress={() => navigation.navigate('IconPicker', { courseId })}
                leadingItem={
                  <Icon
                    icon={
