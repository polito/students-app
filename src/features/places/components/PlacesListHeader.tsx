...
import { faCircleDot, faEllipsisV, faFlagCheckered } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <View style={styles.bottomSheetContent}>
            <View style={styles.selector}>
                ...
                {
                    computeButtonState > 0 && distance && stairsOrElevators && !isExpandedDest && !isExpandedStart && (
                        <View style={styles.statisticsContainer}>
                            <StatisticsContainer totDistance={distance} stairsOrElevators={stairsOrElevators} avoidStairs={avoidStairs} />
                        </View>
                    )
                }
