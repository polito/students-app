...
export const MarkerSelectionBottomSheet = ({ action, clickMode, handleRoom, handleSearch }: Props) => {
    ...
    const { fontSizes, dark , palettes, spacing } = useTheme();
    ...
    const floorSelectorButton = useMemo(() => (
        <TranslucentCard
                    ...
                    <View style={styles.textGrid}>
                        {
                            selectedPlace ? (
                                <>
                                    ...
                                    <Text style={[styles.textSelected, { fontSize: fontSizes.md, color: palettes.gray[dark ? 300 : 600] }]}>
